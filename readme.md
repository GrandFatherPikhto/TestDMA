...
Устройство вполне применимо для управления импульсным устройством питания, рассчитанным, скажем для управления импульнсым устройством питания в пульсирующем режиме, где нужна точность &pm; 2.5us, 

...
Конечно, можно сократить количество точек, но если нужно будет настраивать частоту семплирования и  динамически изменять конфигурацию сигнала, такое решение будет понятным.

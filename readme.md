...
Конечно, можно сократить количество точек, но если нужно будет динамически настраивать частоту семплирования, скажем от 100 КГц до 1МГц и с большой точностью изменять конфигурацию сигнала (задержка, длина импульсной полосы и т.д.), такое решение будет понятным.

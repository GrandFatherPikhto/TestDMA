...
Устройство вполне применимо например, для управления импульсным устройством питания в пульсирующем режиме, где нужна погрешность задержки от управляющего импульса не более &pm; 2.5us, 
